               ...
               <Button className="btn" onClick={() => this.setState({ open: !this.state.open })}>
                ...
                {this.props.tasks.map((task, i) => {  
                        ...
                        <div class="row"  key={task.id}>
                            ...
                            <div class="col-4">
                            <input onChange={(event) => this.changeNameTask(event, task.id)} class = "name-task" value = {this.state.nameTasks[task.id]} size = '15'/>
                            </div>
                            <div class="col-2">
                            ...
                            <svg  data-key = {task.id} class={visible3} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-testid="checkbox-icon">
                            ...
                            <svg  data-key = {task.id} class={visible4} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-testid="checkbox-icon">
